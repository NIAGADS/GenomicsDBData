...
ACCESSIONS=("NG00126" "NG00122" "GCST90027158" "NG00027" "NG00036" "NG00039" "NG00040" "NG00048" "NG00049" "NG00052" "NG00053" "NG00055" "NG00056" "NG00058" "NG00073" "NG00075" "NG00076" "NG00078" "NG00115")
TRACKS=("NG00126_WES,NG00126_WGS" "NG00122" "GCST90027158" "NG00027_GRCh38_ADJ_STAGE1,NG00027_GRCh38_ADJ_STAGE12,NG00027_GRCh38_ADJ_STAGE2,NG00027_GRCh38_STAGE12,NG00027_GRCh38_STAGE1,NG00027_GRCh38_STAGE2" "NG00036_GRCh38_STAGE1,NG00036_GRCh38_STAGE12" "NG00039_GRCh38,NG00039_GRCh38_ADJ" "NG00040_GRCh38_AD,NG00040_GRCh38_PSP,NG00040_GRCh38_FTD" "NG00048_GRCh38" "NG00049_GRCh38_AB42,NG00049_GRCh38_TAU,NG00049_GRCh38_PTAU" "NG00052_GRCh38" "NG00053_GRCh38" "NG00055_AB42,NG00055_GRCh38_TAU,NG00055_GRCh38_PTAU" "NG00056_GRCh38_ALL,NG00056_GRCh38_APOE_E4,NG00056_GRCh38_NON_APOE_E4,NG00056_GRCh38_ALL_APOE_ADJ" "NG00058_GRCh38" "NG00073_GRCh38_MEM,NG00073_GRCh38_VSP,NG00073_GRCh38_LANG,NG00073_GRCh38_NONE,NG00073_GRCh38_MIX" "NG00075_GRCh38_STAGE1,NG00075_GRCh38_STAGE2" "NG00076_GRCh38"  "NG00078_GRCh38_ALL,NG00078_GRCh38_APOE4_CARRIERS,NG00078_GRCh38_APOE4_NON_CARRIERS,NG00078_GRCh38_INT" "NG00115_GRCh38_MALE,NG00115_GRCh38_FEMALE")

# "NG00045" 
# "NG00045_GRCh38_EUR_STAGE12,NG00045_GRCh38_STAGE12,NG00045_GRCh38_EUR_STAGE1,NG00045_GRCh38_STAGE1"
...
if [ "${TRACK}" = "NG00041" ]; then
    ...
    do
        export_summary_statistics.py --accession NG00041 --track "${TID}" --bedFile -o $OUTPUT_PATH 
#        export_summary_statistics.py --accession NG00041 --track "${TID}" --bedFile --inclRestricted -o $OUTPUT_PATH &
    done
else
    NUM_ACCESSIONS=${#ACCESSIONS[@]}
    for (( i=0; i<${NUM_ACCESSIONS}; i++ ));
    do
        export_summary_statistics.py --accession ${ACCESSIONS[$i]} --track "${TRACKS[$i]}" --bedFile -o $OUTPUT_PATH 
	#        export_summary_statistics.py --accession ${ACCESSIONS[$i]} --track "${TRACKS[$i]}" --bedFile --inclRestricted -o $OUTPUT_PATH &
    done
fi

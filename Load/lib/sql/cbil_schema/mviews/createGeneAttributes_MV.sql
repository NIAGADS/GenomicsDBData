...
find_bin_index(nas.chromosome, nl.start_min::bigint, nl.end_max::bigint) AS bin_index,
find_bin_index(nas.chromosome, nl.start_min::bigint - 5000, nl.end_max::bigint + 5000) AS bin_index_5kb_flank,
find_bin_index(nas.chromosome, nl.start_min::bigint - 10000, nl.end_max::bigint + 10000) AS bin_index_10kb_flank,
find_bin_index(nas.chromosome, nl.start_min::bigint - 50000, nl.end_max::bigint + 50000) AS bin_index_50kb_flank,
find_bin_index(nas.chromosome, nl.start_min::bigint - 100000, nl.end_max::bigint + 100000) AS bin_index_100kb_flank,
find_bin_index(nas.chromosome, nl.start_min::bigint - 200000, nl.end_max::bigint + 200000) AS bin_index_200kb_flank,

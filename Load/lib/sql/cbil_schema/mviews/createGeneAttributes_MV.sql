...
nas.chromosome,
nl.start_min::integer AS location_start,
nl.end_max::integer AS location_end,
nl.is_reversed::text::boolean AS is_reversed,

find_bin_index(nas.chromosome, nl.start_min::integer, nl.end_max::integer) AS bin_index,
find_bin_index(nas.chromosome, nl.start_min::integer - 5000, nl.end_max::integer + 5000) AS bin_index_5kb_flank,
find_bin_index(nas.chromosome, nl.start_min::integer - 10000, nl.end_max::integer + 10000) AS bin_index_10kb_flank,
find_bin_index(nas.chromosome, nl.start_min::integer - 50000, nl.end_max::integer + 50000) AS bin_index_50kb_flank,
find_bin_index(nas.chromosome, nl.start_min::integer - 100000, nl.end_max::integer + 100000) AS bin_index_100kb_flank,
find_bin_index(nas.chromosome, nl.start_min::integer - 200000, nl.end_max::integer + 200000) AS bin_index_200kb_flank,

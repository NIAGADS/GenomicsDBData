...
find_bin_index(nas.source_id, nl.start_min::bigint - 5000, nl.end_max::bigint + 5000) AS bin_index_5kb_flank,
find_bin_index(nas.source_id, nl.start_min::bigint - 10000, nl.end_max::bigint + 10000) AS bin_index_10kb_flank,

...
CREATE MATERIALIZED VIEW NIAGADS.TranscriptAttributes AS (
       ...
       , find_bin_index(nas.chromosome, tl.start_min::integer, tl.end_max::integer) AS bin_index
       ...
       , tl.start_min::integer AS location_start
       , tl.end_max::integer AS location_end
       , tl.is_reversed
       , nas.chromosome

## LoadVariantPhenotype.pm.pm
## $Id: LoadVariantPhenotype.pm.pm $
##

package GenomicsDBData::Load::Plugin::LoadVariantPhenotype;
  ...
  my $argumentDeclaration  =
    [
     ...
     stringArg({ name  => 'vepCacheDir',
      ...
      stringArg({ name  => 'inputFileType',
                 descr => "bed/BED or vcf/VCF",
                 constraintFunc => undef,
                 isList         => 0,
		 reqd => 1
	       }),

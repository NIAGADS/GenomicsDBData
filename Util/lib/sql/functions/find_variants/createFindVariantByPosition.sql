...
BEGIN
	...
	FROM AnnotatedVDB.Variant v -- , bin b
	WHERE chromosome = chr AND v.bin_index @> binIndex --b.bin_index
...
DROP FUNCTION IF EXISTS find_normalized_variant_by_position(chr TEXT, pos INTEGER, firstHitOnly BOOLEAN);
